...
${text}`;
  ...
  renderMessageToContainer(container, role, content, timestamp) {
  ...
  scrollToCurrentMatch() {
    ...
    if (wrappers[wrapperIndex]) {
      const target = wrappers[wrapperIndex];
